...
import { Menu, X, LayoutDashboard, UserPlus, BookOpenText, UserRound } from "lucide-react"
...
const Sidebar = () => {
  ...
  const menuItems = [
    { title: "Dashboard", href: `/${code}/student/dashboard`, icon: LayoutDashboard },
    { title: "Enrollment", href: `/${code}/student/enroll`, icon: UserPlus },
    { title: "My Courses", href: `/${code}/student/courses`, icon: BookOpenText },
    { title: "Profile", href: `/${code}/student/profile`, icon: UserRound },
  ]
